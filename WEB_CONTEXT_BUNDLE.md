...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-119-erd-s-problem-119-0f74aba5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-119"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-119-erd-s-problem-119-0f74aba5-v1",
      "problem_contract_sha256": "1aba4e8c36090116eb58828427cfac158a504fbacab660bd494ad6a538c239d4",
      "problem_id": "problem:um-ep-119-erd-s-problem-119-0f74aba5",
      "route_id": "route:um-ep-119-erd-s-problem-119-0f74aba5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-119-erd-s-problem-119-0f74aba5-source-fidelity-01",
      "graph_id": "graph:um-ep-119-erd-s-problem-119-0f74aba5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-119-erd-s-problem-119-0f74aba5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-119-erd-s-problem-119-0f74aba5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $z_i$ be an infinite sequence of complex numbers such that $\\lvert z_i\\rvert=1$ for all $i\\geq 1$, and for $n\\geq 1$ let $ p_n(z)=\\prod_{i\\leq n} (z-z_i). $ Let $M_n=\\max_{\\lvert z\\rvert=1}\\lvert p_n(z)\\rvert$. Is it true that $\\limsup M_n=\\infty$? Is it true that there exists $c>0$ such that for infinitely many $n$ we have $M_n > n^c$? Is it true that there exists $c>0$ such that, for all large $n$, $ \\sum_{k\\leq n}M_k > n^{1+c}? $"
          },
          "statement_sha256": "00ed139800d9b1e299f121f16f2b51b8038255ad54268b0c7d5d168350e25844"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-119-erd-s-problem-119-0f74aba5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-119-erd-s-problem-119-0f74aba5-root",
      "route_id": "route:um-ep-119-erd-s-problem-119-0f74aba5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-119-fc1ac8607095",
        "url": "https://www.unsolvedmath.com/problems/EP-119"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
